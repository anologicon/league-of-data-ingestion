...
summoner_matches_df = spark.read.format("delta").load("s3a://league-of-data-silver/summoner/matches")
...
match_data_df = matches_df.withColumn("participants", explode(matches_df.participants)).select("gameCreation", \
"gameDuration",
"gameEndTimestamp",
"gameId",
"gameMode",
...
match_completed_df = match_data_df.withColumn("teams", explode(match_data_df.teams)).select(
...
match_completed_df.write.mode("overwrite").partitionBy("match").format("delta").save("s3a://league-of-data-gold/matchs/")